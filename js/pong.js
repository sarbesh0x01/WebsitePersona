...
var ASM_CONSTS = {
  92664: () => { if (document.fullscreenElement) return 1; },  
 92710: () => { return Module.canvas.width; },  
 92742: () => { return parseInt(Module.canvas.style.width); },  
 92790: () => { document.exitFullscreen(); },  
 92817: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 92890: () => { if (document.fullscreenElement) return 1; },  
 92936: () => { return Module.canvas.width; },  
 92968: () => { return screen.width; },  
 92993: () => { document.exitFullscreen(); },  
 93020: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 93153: () => { return window.innerWidth; },  
 93179: () => { return window.innerHeight; },  
 93206: () => { if (document.fullscreenElement) return 1; },  
 93252: () => { return Module.canvas.width; },  
 93284: () => { return parseInt(Module.canvas.style.width); },  
 93332: () => { if (document.fullscreenElement) return 1; },  
 93378: () => { return Module.canvas.width; },  
 93410: () => { return screen.width; },  
 93435: () => { return window.innerWidth; },  
 93461: () => { return window.innerHeight; },  
 93488: () => { if (document.fullscreenElement) return 1; },  
 93534: () => { return Module.canvas.width; },  
 93566: () => { return screen.width; },  
 93591: () => { document.exitFullscreen(); },  
 93618: () => { if (document.fullscreenElement) return 1; },  
 93664: () => { return Module.canvas.width; },  
 93696: () => { return parseInt(Module.canvas.style.width); },  
 93744: () => { document.exitFullscreen(); },  
 93771: ($0) => { Module.canvas.style.opacity = $0; },  
 93809: () => { return screen.width; },  
 93834: () => { return screen.height; },  
 93860: () => { return window.screenX; },  
 93887: () => { return window.screenY; },  
 93914: () => { return window.devicePixelRatio; },  
 93950: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 94003: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 94054: () => { Module.canvas.style.cursor = 'none'; },  
 94091: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 94347: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 94398: () => { if (document.pointerLockElement) return 1; },  
 94445: () => { if (document.fullscreenElement) return 1; },  
